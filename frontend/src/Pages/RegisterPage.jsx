...
function RegisterPage() {
  return (
    <div>
      ...
      <h1 className='text-3xl font-semibold text-center text-green-950 '>Register as Freelancer</h1>
        <CustomInput placeholder="Enter your name" label="Name" type="text" />
        <CustomInput placeholder="Ipfs hash" label="IPFS hash" type="text" />
        <button className='bg-green-950 rounded-xl px-6 py-3 text-white inline w-28 text-lg mt-10 justify-self-end'>register</button>
      </form>
